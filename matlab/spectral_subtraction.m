fprintf(' Noise suppression using Spectral Subtraction \n\n');
%Load noise sound example
[y,Fe]=audioread('pk.wav');
...
%Listen result of output

fprintf('Write Noise_suppressed_speech.wav');
audiowrite('noise_suppressed_speech.wav',output_signal,Fe);